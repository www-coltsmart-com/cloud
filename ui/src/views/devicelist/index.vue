    ...
    <section>
         <el-col :span="24" class="toolbar">
      	...
      	<el-table :data="table.devices" highlight-current-row :loading="table.loading" 
			...
			<el-table-column prop="DeviceId" label="序列号" width="150" sortable>
			</el-table-column>
            <el-table-column prop="DeviceType" label="型号" width="100" sortable>
			</el-table-column>
			...
			<el-table-column prop="UserOwn" label="使用人" width="100" sortable>
			</el-table-column>
			<el-table-column prop="Gps" label="GPS坐标" width="100" sortable>
			</el-table-column>
			<el-table-column prop="Version" label="版本" width="100" sortable>
			</el-table-column>
			<el-table-column prop="ComPortNum" label="端口" width="100" sortable>
			</el-table-column>
    ...
    methods: {
        ...
        handleDel: function (row) {
			this.$confirm('确认删除该记录吗？', '提示', { type: 'warning' }).then(() => {
				...
				this.$http.delete('/api/devices/'+row.Id).then((res) => {
